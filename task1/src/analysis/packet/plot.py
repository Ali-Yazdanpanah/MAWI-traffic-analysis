#!/usr/bin/env python3
"""Entry point: packet-level plots (features + distributions)."""
...
from analysis.packet import distributions, features  # noqa: E402
from analysis.plot_cli import main_level, plot_all_level  # noqa: E402
from analysis.results_paths import PACKET_DISTRIBUTION, PACKET_FEATURES  # noqa: E402
...
def main(argv=None) -> int:
    return main_level(
        "packet",
        features_category=PACKET_FEATURES,
        distribution_category=PACKET_DISTRIBUTION,
        features_mod=features,
        distributions_mod=distributions,
        description="Plot packet-level figures from MAWI JSONL.",
        argv=argv,
    )
