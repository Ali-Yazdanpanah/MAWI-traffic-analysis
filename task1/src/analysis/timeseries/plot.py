#!/usr/bin/env python3
"""Entry point: time-series plots (features + distributions)."""
...
from analysis.results_paths import TIMESERIES_DISTRIBUTION, TIMESERIES_FEATURES  # noqa: E402
from analysis.timeseries import distributions, features  # noqa: E402
...
def main(argv=None) -> int:
    return main_level(
        "timeseries",
        features_category=TIMESERIES_FEATURES,
        distribution_category=TIMESERIES_DISTRIBUTION,
        features_mod=features,
        distributions_mod=distributions,
        description="Plot time-series figures from MAWI JSONL.",
        argv=argv,
    )
