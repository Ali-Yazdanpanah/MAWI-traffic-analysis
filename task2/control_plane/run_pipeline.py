...
from bmv2_cli import read_active_flows as read_active_flows_thrift
from bmv2_cli import read_global_state as read_global_state_thrift
from bmv2_cli import reset_telemetry_registers as reset_telemetry_registers_thrift
...
from bootstrap import default_capture_path  # noqa: E402
from capture_packets import capture_from_pcap, write_jsonl  # noqa: E402
from plot_analysis import plot_all  # noqa: E402
...
def main() -> int:
    ...
    packets = __import__("bootstrap").load_packets(args.capture_jsonl, limit=args.limit)
